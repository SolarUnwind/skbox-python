...
x = 8 # начальная позиция по оси x
...
while True:
    ...
    if command == "W" and y < 20: # движение на север
        y += 1
    elif command == "S" and y > 1: # движение на юг
        y -= 1
    elif command == "A" and x > 1: # движение на запад
        x -= 1
    elif command == "D" and x < 15: # движение на восток
        x += 1
    else:
        print("Ввод не распознан, либо упёрлись в стену...")
