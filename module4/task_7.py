...
remaining_credit = float(input("Введите остаток по кредиту: "))
food_expenses = float(input("Введите траты на еду: "))

# Расчет заработной платы по формуле
salary = 200 * hours_worked / 2 ** 3 + hours_worked

# Проверка, хватит ли зарплаты на кредит и еду
if salary >= (remaining_credit + food_expenses):
